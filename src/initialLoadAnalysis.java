...
public class initialLoadAnalysis implements Runnable {
    ...
    static initialLoadAnalysis tail ;
    ...
    public static void main(String[] args) throws IOException, NumberFormatException, ParseException {
        ...
        Runtime.getRuntime().addShutdownHook(new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    Logger.getLogger(initialLoadAnalysis.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        ...
        tail = new initialLoadAnalysis(log);
        
       new Thread(tail).start();

    }

    public initialLoadAnalysis(File file) {
        this._file = file;
    }
    ...
    public void run() {
        try {
            ...
            while (keepRunning) {
    	        ...
    	        String res = null;
    	        String search=initialLoadAnalysis.process+".rpt";
    	        String lineProc;
            ...
            this.appendMessage("GoldenGate processus "+process + " not running");
	...
	static void checkRate(String path) throws IOException, ParseException, NumberFormatException {
		...
		for (int i = 0; i < files.length; i++) {
			if (files[i].getName().indexOf(process+".rpt")>=0)
			{
				...
				try {
					writer = new BufferedWriter(new FileWriter(path+files[i].getName().replace(".rpt",".csv")));
				} catch (Exception e1) {
